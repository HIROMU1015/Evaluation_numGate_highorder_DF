...
# -------------------------
# Surface-code estimation
# -------------------------
# 初期値は簡易見積もり用の暫定値。
# 文献に合わせた値へ後から差し替えることを想定している。
SURFACE_CODE_P_TH = 1.0e-2
SURFACE_CODE_A_EFF_DEFAULT = 1.0
SURFACE_CODE_A_EFF_CASES = (0.1, 1.0, 10.0)
...
SURFACE_CODE_DF_ROTATION_LAYER_PREFERRED_KEY = "total_nonclifford_z_coloring_depth"
SURFACE_CODE_DECOMPOSE_CHUNK_MAX_OPS = 250_000
SURFACE_CODE_DECOMPOSE_MAX_WORKERS = 2
SURFACE_CODE_PROXY_DEPTH_MULTIPLIER = 3.0
SURFACE_CODE_PROXY_GATE_COUNT_PER_MAGIC = 5.0
SURFACE_CODE_PROXY_RUNTIME_PER_MAGIC = 4.5
SURFACE_CODE_AUTO_POPULATE = True
...
SURFACE_CODE_RZ_CALL_CACHE_INLINE_BEFORE_COMPILE = True
SURFACE_CODE_RZ_CALL_CACHE_HELPER_MAX_WORKERS = SURFACE_CODE_DECOMPOSE_MAX_WORKERS
SURFACE_CODE_FTQC_CALLGRAPH_FALLBACK_MAX_RZ = 20_000
